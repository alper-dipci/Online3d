...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            followCamera = GameObject.FindGameObjectWithTag("FollowCamera").GetComponent<Cinemachine.CinemachineVirtualCamera>();
            ...
            focusCamera.Follow = CinemachineCameraTarget.transform;           
